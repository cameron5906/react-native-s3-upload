...
var RNS3 = exports.RNS3 = function () {
  ...
  _createClass(RNS3, null, [{
    key: 'put',
    value: function put(file, options, sessionToken) {
      ...
      return _Request.Request.create(url, method, policy, { 'X-Amz-Security-Token': sessionToken }).set("file", file).send().then(setBodyAsParsedXML);
    }
  }]);
